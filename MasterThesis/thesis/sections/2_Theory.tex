...
The starting point for accumulating damage are cracks in the material. These cracks are modeled as thresholds that are randomly distributed through the material following a Weibull distribution.
