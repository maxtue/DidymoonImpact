...
\end{frame}
\begin{frame}{Target}
	typical representative of possible hazardious asteroid
...
\end{itemize} 
	Papers:
\begin{itemize}
	\item "Modeling impact outcomes for the Double Asteroid Redirection
Test (DART) mission", Stickle et al., Procedia Engineering 2017
