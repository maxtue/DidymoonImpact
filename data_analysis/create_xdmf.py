...
# scalar floats only 
wanted_attributes = ['rho', 'p', 'sml', 'e', 'material_type', 'number_of_interactions', 'damage_total', 'alpha_jutzi', 'soundspeed']
...
#wanted_attributes = ['rho', 'p', 'sml', 'e', 'material_type', 'number_of_interactions' ]
