...
f.write(
    ...
    f"python3 ../../../impact_ini/impact_ini.py --outfile impact_{args.name}.0000 --N_targ_des {args.particles} --angle {args.angle} --alpha_targ {args.porosity} --sml_fact 2.1 --weibull_m 16.0 --weibull_k 1e61 --damage 0.0 --stress 0.0 --alpha_proj 1.0 --pressure 0.0\n\n"
